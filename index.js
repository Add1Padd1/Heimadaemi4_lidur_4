...
function render() {
  ...
  mv1 = mult(mv1, scalem(0.05, 1.0, 0.3));
  ...
  mv1 = mult(mv1, scalem(0.85, 0.05, 0.3));
  gl.uniformMatrix4fv(matrixLoc, false, flatten(mv1));
  gl.drawArrays(gl.TRIANGLES, 0, numVertices);

  // Efri Miðju barinn
  mv1 = mult(mv, translate(0.0, 0.2, 0.0));
  mv1 = mult(mv1, scalem(0.75, 0.05, 0.3));
  gl.uniformMatrix4fv(matrixLoc, false, flatten(mv1));
  gl.drawArrays(gl.TRIANGLES, 0, numVertices);
  // Neðri Miðju barinn
  ...
  // Aftan við skápinn
  mv1 = mult(mv, translate(0.0, 0.01, 0.125));
  mv1 = mult(mv1, scalem(0.75, 1.014, 0.05));
  gl.uniformMatrix4fv(matrixLoc, false, flatten(mv1));
  gl.drawArrays(gl.TRIANGLES, 0, numVertices);
